...
local function groups(c, opts)
  ...
  return {
    ...
    ["@lsp.typemod.keyword.async.rust"] = { link = "@keyword" },
    ["@lsp.typemod.keyword.macro.rust"] = { link = "@keyword" },
    ["@lsp.typemod.keyword.procMacro.rust"] = { link = "@keyword" },
    ["@lsp.mod.async.rust"] = { link = "@keyword" },
    ["@lsp.mod.macro.rust"] = { link = "@keyword" },
    ["@lsp.mod.procMacro.rust"] = { link = "@keyword" },
