...
local function groups(c, opts)
  ...
  return {
    ...
    ["@keyword.import"] = with_user_style({ fg = c.storage, bold = true }, keyword_style),
    ...
    ["@keyword.modifier.rust"] = with_user_style({ fg = c.storage, bold = true }, keyword_style),
    ["@keyword.type.rust"] = with_user_style({ fg = c.storage, bold = true }, keyword_style),
    ["@label"] = { fg = c.keyword },
    ...
    -- Rust semantic tokens: keep neutral so tree-sitter/token groups control colors.
    ["@lsp.type.keyword.rust"] = { link = "@lsp" },
    ["@lsp.typemod.keyword.declaration.rust"] = { link = "@lsp" },
    ["@lsp.typemod.keyword.mutable.rust"] = { link = "@lsp" },
    ["@lsp.typemod.keyword.modification.rust"] = { link = "@lsp" },
    ["@lsp.typemod.keyword.async.rust"] = { link = "@lsp" },
    ["@lsp.typemod.keyword.macro.rust"] = { link = "@lsp" },
    ["@lsp.typemod.keyword.procMacro.rust"] = { link = "@lsp" },
    ["@lsp.mod.async.rust"] = { link = "@lsp" },
    ["@lsp.mod.macro.rust"] = { link = "@lsp" },
    ["@lsp.mod.procMacro.rust"] = { link = "@lsp" },
